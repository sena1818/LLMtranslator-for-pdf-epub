...
class TranslationComponentsTestCase(unittest.TestCase):
    def test_document_analyzer_parse(self):
        class Config:
    ...
    def test_prompt_builder_contains_translation_contract(self):
        ...
        self.assertIn("完整保留所有 Markdown 格式", rendered)
        self.assertIn("核心术语表", rendered)

    def test_quality_pipeline_repairs_via_checker(self):
        class Config:
        ...
        self.assertEqual(translation, "修正后的译文")
